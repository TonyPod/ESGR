...
with tf.Session() as session:
    ...
    # train_gen, dev_gen = lib.cifar100.load(BATCH_SIZE, DATA_DIR, range(10))
    train_gen, dev_gen = lib.cifar10.load(BATCH_SIZE, DATA_DIR, range(10))
