...
@author: Chen He 
@site:  
@file: visualize_train_disc_cost_and_samples.py
@description:  
"""
...
RESULT_SUB_FOLDER = 'finetune_cifar-100_0.0001_200000_all_classes'
OUTPUT_BASE_FOLDER = 'result_train_disc_cost'
...
for class_idx in range(0, 100):
    ...
    with open(log_file, 'rb') as f:
        log = pickle.load(f)
    train_disc_cost = log['train disc cost']
