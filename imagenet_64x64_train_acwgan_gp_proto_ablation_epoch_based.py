...
flags.DEFINE_string('exemplars_base_folder', 'acwgan_gp_proto_high_1.0-1.0_icarl_2000', '')
...
def main(_):
    ...
    result_base_folder = os.path.join(FLAGS.result_dir, FLAGS.dataset + ('_flip' if FLAGS.flip else ''),
